...
condition = 'visual'; % or condition = 'visual';
sub = 13;
addpath('utils/')
...
[J_rec,~] = stout(data.x,head_model.L,B,'tstep',4,'wsize',80,...
    'Winv',Winv,'sreg',90,'treg',30,'tol',1e-3,'optimres',true);
save([condition 's' num2str(sub) 'nt2.mat'],'J_rec')
